  ...
  (
    ...
    return !isLoading ? (
      <Button
        ...
        } dark:bg-slate-600 text-white dark:text-white dark:font-bold hover:underline shadow-xl ${propWidth} md:${propWidth}  select-none rounded-[0.625rem] hover:opacity-90 ${variant_hover} ${size_height} ${classes}`}
      ...
      <Button
        className={`bg-primary dark:bg-black text-white ${propWidth} md:${propWidth} select-none rounded-[0.625rem] cursor-not-allowed ${size_height} ${
          classes ? classes : ""
        }`}
        ref={ref}
        disabled
